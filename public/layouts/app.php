...
<head>
    ...
    <meta name="description"
        content="Empowering healthcare through exceptional virtual support. Sakari Management Group provides skilled virtual assistants for utilization management, care coordination, billing, transcription, and more.">
    <meta name="keywords"
        content="Sakari Management Group, virtual healthcare assistants, healthcare outsourcing, utilization management, care coordination, medical transcription, healthcare VAs, virtual nurse, medical VA, virtual assistant healthcare, medical billing, healthcare support">
    ...
    <meta property="og:description"
        content="Streamline your operations with skilled virtual assistants. Led by U.S.-trained clinicians, Sakari offers scalable, compliant, and cost-effective healthcare staffing solutions.">
    <meta property="og:image" content="https://sakariwellness.com/images/og-image.jpg">
    ...
    <meta name="twitter:description"
        content="Empowering healthcare through exceptional virtual support. Discover tailored solutions for billing, care coordination, and more.">
    <meta name="twitter:image" content="https://sakariwellness.com/images/twitter-card.jpg">
    <!-- Replace with your actual Twitter card image URL -->
...
?>
    <header id="header" class="header d-flex align-items-center fixed-top ">
        <div class="container-fluid container-xl position-relative d-flex align-items-center">
            ...
            <nav id="navmenu" class="navmenu">
                <ul>
                    <li><a href="<?= $baseUrl ?><?= $isHome ? '' : '' ?>#hero" <?= $isHome ? 'class="active"' : '' ?>>Home</a></li>
                    <li><a href="<?= $baseUrl ?>#about">About</a></li>
                    <li><a href="<?= $baseUrl ?>#team">Team</a></li>
                    <li><a href="<?= $baseUrl ?>#services">Services</a></li>
                    <li><a href="<?= $baseUrl ?>#contact">Contact</a></li>
                    <li><a href="<?= $baseUrl ?>blog" <?= in_array($currentRoute, ['blog', 'blog-post']) ? 'class="active"' : '' ?>>Blog</a></li>
                    <li><a href="<?= $baseUrl ?>careers" <?= $currentRoute === 'careers' ? 'class="active"' : '' ?>>Careers</a></li>
                </ul>
                <i class="mobile-nav-toggle d-xl-none bi bi-list"></i>
            </nav>

            <a class="cta-btn" href="https://calendly.com/junettecacho-sakarimanagement/30min">Apply Now</a>
        ...
        <div class="container footer-top">
            <div class="row gy-4">
                <div class="col-lg-4 col-md-6 footer-about">
                    ...
                    <div class="footer-contact pt-3">
                        ...
                        <p class="mt-3"><strong>Phone:</strong><br>
                            <span>+19097232671</span><br>
                            <span>+639171686148</span>
                        </p>
                        <p><strong>Email:</strong><br>
                            <span>agency@sakarimanagement.com</span>
                        </p>
                    </div>
                    <div class="social-links d-flex mt-4">
                        <a href="#"><i class="bi bi-twitter-x"></i></a>
                        <a href="https://www.facebook.com/profile.php?id=61573640922847" target="_blank"><i
                ...
                <div class="col-lg-4 col-md-6 footer-links">
                    ...
                    <p>
                        Sakari Management Group is committed to safeguarding your information. We collect only necessary
                        data to deliver services and never share or sell your information. By using this website, you
                ...
                <div class="col-lg-4 col-md-6 footer-links">
                    ...
                    <p>
                        Use of this website and our services is subject to the terms outlined herein. Sakari Management
                        Group reserves the right to update services, pricing, and policies. Clients are expected to
                        comply with data protection and contractual terms.
                    </p>
                </div>
            </div>
        </div>
    ...
    <script src="<?= $baseUrl ?>assets/vendor/imagesloaded/imagesloaded.pkgd.min.js"></script>
